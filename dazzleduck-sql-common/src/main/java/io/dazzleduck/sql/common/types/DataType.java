...
public interface DataType {
    ...
    public static class Field {
        ...
        public boolean equals(Object obj) {
            ...
            Field f = (Field) obj;
            return f.name.equals(name) && f.dataType.equals(dataType);
        }
    }
    ...
    public static class Decimal implements DataType {
        ...
        public boolean equals(Object obj) {
            ...
            return d.width == width && d.scale == scale;
        }
    }
    ...
    public static class Struct implements DataType {
        ...
        public boolean equals(Object obj) {
            ...
            Struct s = (Struct) obj;
            if (s.fields.size() != fields.size()) return false;
        ...
        public boolean hasNullType() {
            for (Field f : fields) {
                if (f.dataType instanceof Struct) {
                    Struct s = (Struct) f.dataType;
    ...
    public static class ArrayType implements  DataType {
        ...
        public boolean equals(Object obj) {
            ...
            return a.internal.equals(this.internal);
        }
    }
    ...
    public static class MapType implements  DataType {
        ...
        public boolean equals(Object obj) {
            ...
            return m.keyType.equals(keyType) && m.valueType.equals(valueType);
        }
    }
