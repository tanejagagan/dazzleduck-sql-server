package io.dazzleduck.sql.logger.demo;
...
/**
 * Continuous demo for the Arrow SLF4J Logger.
 *
 * <p>This demo generates sample logs continuously (every 500ms) using the
 * ArrowSimpleLogger SLF4J provider, which forwards logs directly to a
 * DazzleDuck server in Arrow format. Press Ctrl+C to stop.
 *
 * <h2>Prerequisites</h2>
 * <ol>
 *   <li>Start a DazzleDuck server on localhost:8081</li>
 *   <li>Configure reference.conf with server connection details</li>
 * </ol>
 *
 * <h2>Run</h2>
 * <pre>
 * ./mvnw exec:java -pl dazzleduck-sql-logger \
 *   -Dexec.mainClass="io.dazzleduck.sql.logger.demo.Demo"
 * </pre>
 */
public class Demo {
    ...
    public static void main(String[] args) {
        System.out.println("=== Arrow SLF4J Logger Demo ===");
        System.out.println("Using SLF4J provider: " + log.getClass().getName());
