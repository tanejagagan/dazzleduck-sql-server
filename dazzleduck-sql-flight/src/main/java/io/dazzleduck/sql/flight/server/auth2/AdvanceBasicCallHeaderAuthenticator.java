...
public class AdvanceBasicCallHeaderAuthenticator implements CallHeaderAuthenticator {
    ...
    public AdvanceBasicCallHeaderAuthenticator(AdvanceCredentialValidator validator) {
    ...
    public AuthResult authenticate(CallHeaders incomingHeaders) {
        try {
            ...
            return validator.validate(user, password, incomingHeaders);
    ...
    public interface AdvanceCredentialValidator {
         ...
         */
        AuthResult validate(String username, String password, CallHeaders callHeaders) throws Exception;
    }
}
